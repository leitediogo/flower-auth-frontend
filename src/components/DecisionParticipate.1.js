...
class DecisionParticipate extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <br />
                <b> Decision: {this.props.location.state.decision.name}</b>
                <br />
                <b> Description: {this.props.location.state.decision.description}</b>
                <FlatButton label="Add Criteria" primary={true} onTouchTap={this.handleAddCriteria} />
